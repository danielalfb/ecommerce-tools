...
|    ID | Tarefa                                                                                                                                                                        | Estimativa | Início | Término |  Status  |
| ----: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :----: | :-----: | :------: |
...
|    ID | Tarefa                                                                                       | Estimativa | Início | Término |  Status  |
| ----: | :------------------------------------------------------------------------------------------- | :--------: | :----: | :-----: | :------: |
| 02-00 | Configurar o ambiente                                                                        |     2      | 15/05  |  15/05  | **DONE** |
| 02-01 | Criar um modelo entidade/relacionamento contendo produtos, departamentos, usuários e pedidos |     3      | 15/05  |  17/05  | **DONE** |
| 02-02 | Converter o modelo MER para o modelo relacional                                              |     3      | 17/05  |  18/05  | **DONE** |
| 02-03 | Elaborar arquivo SQL com as instruções de criação de todas as tabelas                        |     1      | 18/05  |  18/05  | **DONE** |
| 02-04 | Criar banco de dados                                                                         |     1      | 18/05  |  18/05  | **DONE** |
| 02-05 | Criar o script de cadastro de produtos                                                       |     3      | 18/05  |  19/05  | **DONE** |
| 02-06 | Teste unitário do script de cadastro de produtos                                             |     1      | 19/05  |  19/05  | **DONE** |
| 02-07 | Criar scipt de cadastro de usuário                                                           |     3      | 19/05  |  20/05  | **DONE** |
| 02-08 | Teste unitário do scipt de cadastro de usuário                                               |     1      | 20/05  |  20/05  | **DONE** |
| 02-09 | Elaborar arquivo SQL com todos os scripts de inserção de dados                               |     1      | 20/05  |  20/05  | **DONE** |
| 02-10 | Criar consultas de contagem ou totalização                                                   |     1      | 20/05  |  20/05  | **DONE** |
| 02-11 | Criar consultas de junção entre duas tabelas                                                 |     1      | 20/05  |  20/05  | **DONE** |
| 02-12 | Criar consultas de junção entre três tabelas                                                 |     1      | 20/05  |  20/05  | **DONE** |
| 02-13 | Criar consultas de junção entre duas tabelas + operação de totalização e agrupamento         |     1      | 20/05  |  20/05  | **DONE** |
| 02-14 | Criar consultas de junção entre três ou mais tabelas + operação de totalização e agrupamento |     1      | 20/05  |  20/05  | **DONE** |
| 02-15 | Elaborar relatório de entrega                                                                |     3      | 20/05  |  21/05  | **DONE** |
